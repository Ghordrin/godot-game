...
# ── Ice Slow Support ──────────────────────────────────────────────────
# Speed properties get multiplied DOWN by Ice slow.
# Interval/cooldown properties get multiplied UP by Ice slow.
#
# Example with 25% slow:
#   speed 200 -> 150
#   interval 0.10 -> 0.133
#
# StatusEffectComponent can read these lists if present.
